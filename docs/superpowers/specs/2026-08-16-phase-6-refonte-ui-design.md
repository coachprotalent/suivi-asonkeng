...
| D129 | **Une exception unique et bornée à D119 est déclarée d'avance** : le remplacement des `window.confirm` (D124) rend **inertes** 22 gestionnaires `page.once('dialog', …)` répartis sur **11 fichiers de preuve**, dont **une des dix preuves de production**. Ces gestionnaires sont adaptés ; **aucune assertion n'est touchée**, et les totaux — 128 et 10 — sont vérifiés par comptage avant et après | D119 et D124 sont **incompatibles tels qu'écrits**, et je ne l'avais pas vu. Un gestionnaire de dialogue natif qui n'a plus de dialogue à intercepter ne rougit pas : il **expire**, loin de sa cause, et le diagnostic naturel serait alors « la refonte a cassé l'écran ». Déclarer l'exception d'avance, la borner à une seule tâche et interdire toute retouche d'assertion est la seule façon de garder D119 utilisable comme filet : une règle absolue qu'on enfreint en silence à la première difficulté ne protège plus rien. **Toute autre preuve qui rougit reste un signal**, sans exception |
